...
pub use crate::versions::gen_r2::*;

pub struct Bq40z50R2<I2C: I2cTrait, DELAY: DelayTrait> {
    pub device: Device<DeviceInterface<I2C, DELAY>>,
    capacity_mode_state: core::cell::Cell<CapacityModeState>,
}

impl<I2C: I2cTrait, DELAY: DelayTrait> Bq40z50R2<I2C, DELAY> {
...
crate::common::implement_embedded_batteries!(Bq40z50R2);

crate::tests::bq40z50_tests!(Bq40z50R2);
