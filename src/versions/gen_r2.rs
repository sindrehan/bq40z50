...
impl<I> Device<I> {
    ...
    pub fn manufacture_info(&mut self) -> ::device_driver::BufferOperation<'_, I, u8, ::device_driver::RW> {
...
pub mod field_sets {
    ...
    impl MacChargingStatusFieldsOut {
        ...
        ///Read the `su` field of the register.
        ///
        pub fn su(&self) -> bool {
            let raw = unsafe { ::device_driver::ops::load_lsb0::<u8, ::device_driver::ops::LE>(&self.bits, 13, 14) };
            raw > 0
        ...
        ///Write the `su` field of the register.
        ///
        pub fn set_su(&mut self, value: bool) {
            let raw = value as _;
            unsafe { ::device_driver::ops::store_lsb0::<u8, ::device_driver::ops::LE>(raw, 13, 14, &mut self.bits) };
        }
    ...
    impl From<[u8; 8]> for MacLifetimeDataBlock2FieldsOut {
        fn from(bits: [u8; 8]) -> Self {
            Self { bits }
        }
    }
    impl From<MacLifetimeDataBlock2FieldsOut> for [u8; 8] {
    ...
    impl MacLifetimeDataBlock3FieldsOut {
        ...
        ///Read the `time_spent_in_ut` field of the register.
        ///
        pub fn time_spent_in_ut(&self) -> u16 {
            let raw = unsafe { ::device_driver::ops::load_lsb0::<u16, ::device_driver::ops::LE>(&self.bits, 16, 32) };
            raw
        }
        ///Read the `time_spent_in_lt` field of the register.
        ///
        pub fn time_spent_in_lt(&self) -> u16 {
            let raw = unsafe { ::device_driver::ops::load_lsb0::<u16, ::device_driver::ops::LE>(&self.bits, 32, 48) };
            raw
        }
        ///Read the `time_spent_in_stl` field of the register.
        ///
        pub fn time_spent_in_stl(&self) -> u16 {
            let raw = unsafe { ::device_driver::ops::load_lsb0::<u16, ::device_driver::ops::LE>(&self.bits, 48, 64) };
            raw
        }
        ///Read the `time_spent_in_rt` field of the register.
        ///
        pub fn time_spent_in_rt(&self) -> u16 {
            let raw = unsafe { ::device_driver::ops::load_lsb0::<u16, ::device_driver::ops::LE>(&self.bits, 64, 80) };
            raw
        }
        ///Read the `time_spent_in_sth` field of the register.
        ///
        pub fn time_spent_in_sth(&self) -> u16 {
            let raw = unsafe { ::device_driver::ops::load_lsb0::<u16, ::device_driver::ops::LE>(&self.bits, 80, 96) };
            raw
        }
        ///Read the `time_spent_in_ht` field of the register.
        ///
        pub fn time_spent_in_ht(&self) -> u16 {
            let raw = unsafe { ::device_driver::ops::load_lsb0::<u16, ::device_driver::ops::LE>(&self.bits, 96, 112) };
            raw
        }
        ///Read the `time_spent_in_ot` field of the register.
        ///
        ...
        ///Write the `time_spent_in_ut` field of the register.
        ///
        pub fn set_time_spent_in_ut(&mut self, value: u16) {
            let raw = value;
            unsafe { ::device_driver::ops::store_lsb0::<u16, ::device_driver::ops::LE>(raw, 16, 32, &mut self.bits) };
        }
        ///Write the `time_spent_in_lt` field of the register.
        ///
        pub fn set_time_spent_in_lt(&mut self, value: u16) {
            let raw = value;
            unsafe { ::device_driver::ops::store_lsb0::<u16, ::device_driver::ops::LE>(raw, 32, 48, &mut self.bits) };
        }
        ///Write the `time_spent_in_stl` field of the register.
        ///
        pub fn set_time_spent_in_stl(&mut self, value: u16) {
            let raw = value;
            unsafe { ::device_driver::ops::store_lsb0::<u16, ::device_driver::ops::LE>(raw, 48, 64, &mut self.bits) };
        }
        ///Write the `time_spent_in_rt` field of the register.
        ///
        pub fn set_time_spent_in_rt(&mut self, value: u16) {
            let raw = value;
            unsafe { ::device_driver::ops::store_lsb0::<u16, ::device_driver::ops::LE>(raw, 64, 80, &mut self.bits) };
        }
        ///Write the `time_spent_in_sth` field of the register.
        ///
        pub fn set_time_spent_in_sth(&mut self, value: u16) {
            let raw = value;
            unsafe { ::device_driver::ops::store_lsb0::<u16, ::device_driver::ops::LE>(raw, 80, 96, &mut self.bits) };
        }
        ///Write the `time_spent_in_ht` field of the register.
        ///
        pub fn set_time_spent_in_ht(&mut self, value: u16) {
            let raw = value;
            unsafe { ::device_driver::ops::store_lsb0::<u16, ::device_driver::ops::LE>(raw, 96, 112, &mut self.bits) };
        }
        ///Write the `time_spent_in_ot` field of the register.
        ///
    ...
    impl From<[u8; 16]> for MacLifetimeDataBlock3FieldsOut {
        fn from(bits: [u8; 16]) -> Self {
            Self { bits }
        }
    }
    impl From<MacLifetimeDataBlock3FieldsOut> for [u8; 16] {
